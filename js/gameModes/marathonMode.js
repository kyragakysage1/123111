class MarathonMode {
                    ...
                    <div class="game-header question-transition">
                        <div style="display: flex; justify-content: space-between; align-items: center; width: 100%; flex-wrap: wrap;">
                            <div style="display: flex; gap: 15px; align-items: center; flex-wrap: wrap;">
                                ...
                                <span>Комбо: <span id="combo">0</span></span>
    ...
    updateGameHeader() {
        ...
        document.getElementById('combo').textContent = window.gameState.combo;
    ...
    handleTimeOut() {
        ...
        this.showResult(false, window.gameState.currentCorrectAnime, 0, 15);
    }
    ...
    checkAnswer(isCorrect, correctAnime, clickedButton) {
        ...
        setTimeout(() => {
            ...
            setTimeout(() => {
                const timeTaken = 15 - window.gameState.timeLeft;
                
                if (isCorrect) {
                    window.gameState.combo++;
                    window.gameState.maxCombo = Math.max(window.gameState.maxCombo, window.gameState.combo);

                    const timeBonus = Math.max(5, 15 - timeTaken);
                    const comboBonus = Math.floor(window.gameState.combo / 3) * 5;
                    const pointsEarned = 25 + timeBonus + comboBonus;
        ...
        resultContainer.innerHTML = `
            <div class="result-content">
                ...
                <div class="result-details">
                    ...
                    <p>Комбо: <span id="current-combo">${window.gameState.combo}</span></p>
    ...
    nextQuestion() {
        if (window.gameState.lives <= 0 && this.name === 'lives') {
            this.endGame();
            return;
        }
    ...
    showFinalStats() {
        ...
        if (finalMode) finalMode.textContent = `${this.displayName} (Макс. комбо: ${window.gameState.maxCombo})`;
    }
}
